...
<img width="1293" height="775" alt="Power BI Blinkit Dashboard" src="https://github.com/user-attachments/assets/b007368a-1324-4e1a-8428-ea36f4770c66" />

🔍 Key Features:
Total Sales: $1.20M with average sales of $141 per item.

Item Insights: 8,523 items analyzed across multiple categories like Fruits, Snacks, Dairy, Meat, and more.

Fat Content Breakdown: Distribution of items between Low Fat and Regular fat content.

Outlet Type & Location Analysis:

Covers Tier 1, Tier 2, Tier 3 cities.

Compares performance of Supermarkets and Grocery Stores.

Average Ratings: 3.9 across all outlets and items.

Establishment Trend: Tracks outlet sales from 2012 to 2022.

Filters: Users can slice data by Outlet Location Type, Outlet Size, and Item Type.
...
DAX Calculation
Dashboard Layouting
Chart Devlopment and Formatting
Insights Generation
